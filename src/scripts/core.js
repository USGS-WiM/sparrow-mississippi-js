...
require([
  ...
  setupQueryTask(serviceBaseURL + 4, ["ST", "GP2", "GP1"], "1=1");
  ...
  app.getLayerConfigObject = function (sparrowLayerId) {
    var configObject = (function (tempLayerId) {
      switch (tempLayerId) {
        ...
        case 8:
          return Group2_tn; // huc12
        case 9:
          return Group1_tn; // huc8
        case 10:
          return ST_tn; // State
        case 11:
        ...
        case 15:
          return Group2_q; // huc8
        case 16:
          return Group1_q; // huc12
        case 17:
          return ST_q; // State
        case 18:
  ...
  function switchWhereField(selectedIndex) {
    switch (selectedIndex) {
      ...
      case 3:
        ...
        //TODO CHECK THE VALUES HERE WHEN STATE IS SELECTED
        /* if (
